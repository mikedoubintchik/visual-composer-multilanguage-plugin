...
This is an add-on plugin for WPBakery Visual Composer that adds multilanguage support and functionality.
...
== Screenshots ==
1. Add list of languages you want to support
2. Edit VC row and select language
